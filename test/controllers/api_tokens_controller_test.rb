...
class ApiTokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_token" do
    assert_difference("ApiToken.count") do
      post api_tokens_url, params: { api_token: { encrypted_access_token: @api_token.encrypted_access_token, encrypted_access_token_iv: @api_token.encrypted_access_token_iv } }
    end
  ...
  test "should update api_token" do
    patch api_token_url(@api_token), params: { api_token: { encrypted_access_token: @api_token.encrypted_access_token, encrypted_access_token_iv: @api_token.encrypted_access_token_iv } }
